...
# Recipeslabel=Label(window,text="Recipes").grid(row=0,column=0)
# scroll_bar = Scrollbar(window, orient=VERTICAL)
# select = Listbox(window, yscrollcommand=scroll_bar.set, height=20)
# scroll_bar.config (command=select.yview)
# scroll_bar.grid(row=2,column=0)
# select.grid(row=1,column=1,columnspan=5,rowspan=2)
# titleNamelabel=Label(window,text="Title").grid(row=1,column=2)
# titleNameEntry=Entry(window,width=50).grid(row=1,column=3)
# ingredientslabel=Label(window,text="Ingredients").grid(row=2,column=2)
# ingredientsEntry=Entry(window).grid(row=2,column=3)
# instructionslabel=Label(window,text="Instructions").grid(row=3,column=2)
# instructionseEntry=Entry(window).grid(row=3,column=3)
# cookingtimelabel=Label(window,text="Cooking time").grid(row=4,column=2)
# cookingtimeentry=Entry(window).grid(row=4,column=3)
# dietaryinfolabel=Label(window,text="Dietary Information").grid(row=5,column=2)
# dietaryinfoentry=Entry(window).grid(row=5,column=3)